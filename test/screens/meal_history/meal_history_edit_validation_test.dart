...
void main() {
  ...
  group('Validation Error Feedback', () {
    // Note: Servings validation tests (zero, negative, empty) are omitted because
    // the ServingsStepper widget enforces min=1 by construction — invalid values
    // are unreachable at the UI level.
