# Recipe Export Analysis — 2026-03-25

Export file: `assets/recipe_export_1774485792871.json`
Total: 189 recipes

---

## Complete (instructions + 2+ ingredients) — 40 recipes
...
## Ingredient list only (2+ ingredients, no instructions) — 54 recipes
...
- chancliche
- macarrão com cogumelos e molho de tomates
- sour cream
- salada caprese
- brócolis com alho
- lentilhas
...
## Stubs (0–1 ingredient) — 95 recipes
